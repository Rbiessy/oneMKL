...
void gebrd(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<std::complex<float>> &a,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::gebrd(queue, m, n, a, lda, d, e, tauq, taup, scratchpad,
                                 scratchpad_size));
}
...
void gerqf(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<float> &a,
           ...
           std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::gerqf(queue, m, n, a, lda, tau, scratchpad, scratchpad_size));
}
...
void geqrf(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<std::complex<float>> &a,
           std::int64_t lda, sycl::buffer<std::complex<float>> &tau,
           sycl::buffer<std::complex<float>> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::geqrf(queue, m, n, a, lda, tau, scratchpad, scratchpad_size));
}
...
void getrf(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<std::complex<float>> &a,
           ...
           sycl::buffer<std::complex<float>> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::getrf(queue, m, n, a, lda, ipiv, scratchpad, scratchpad_size));
}
...
void getri(sycl::queue &queue, std::int64_t n, sycl::buffer<std::complex<float>> &a,
           std::int64_t lda, sycl::buffer<std::int64_t> &ipiv,
           sycl::buffer<std::complex<float>> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::getri(queue, n, a, lda, ipiv, scratchpad, scratchpad_size));
}
...
void getrs(sycl::queue &queue, oneapi::math::transpose trans, std::int64_t n, std::int64_t nrhs,
           ...
           sycl::buffer<std::complex<float>> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::getrs(queue, detail::get_onemkl_transpose(trans), n, nrhs, a, lda, ipiv, b, ldb, scratchpad,
                                 scratchpad_size));
}
void getrs(sycl::queue &queue, oneapi::math::transpose trans, std::int64_t n, std::int64_t nrhs,
...
void gesvd(sycl::queue &queue, oneapi::math::jobsvd jobu, oneapi::math::jobsvd jobvt, std::int64_t m,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::gesvd(queue, detail::get_onemkl_jobsvd(jobu), detail::get_onemkl_jobsvd(jobvt), m, n, a, lda, s, u, ldu, vt, ldvt, scratchpad,
                                 scratchpad_size));
}
void gesvd(sycl::queue &queue, oneapi::math::jobsvd jobu, oneapi::math::jobsvd jobvt, std::int64_t m,
...
void heevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
           ...
           sycl::buffer<std::complex<float>> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::heevd(queue, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, a, lda, w, scratchpad, scratchpad_size));
}
void heevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
...
void hegvd(sycl::queue &queue, std::int64_t itype, oneapi::math::job jobz, oneapi::math::uplo uplo,
           ...
           sycl::buffer<std::complex<float>> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::hegvd(queue, itype, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, a, lda, b, ldb, w, scratchpad,
                                 scratchpad_size));
}
void hegvd(sycl::queue &queue, std::int64_t itype, oneapi::math::job jobz, oneapi::math::uplo uplo,
           std::int64_t n, sycl::buffer<std::complex<double>> &a, std::int64_t lda,
...
void hetrd(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
           ...
           sycl::buffer<std::complex<float>> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::hetrd(queue, detail::get_onemkl_uplo(uplo), n, a, lda, d, e, tau, scratchpad, scratchpad_size));
}
void hetrd(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
           sycl::buffer<std::complex<double>> &a, std::int64_t lda, sycl::buffer<double> &d,
...
void hetrf(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
           sycl::buffer<std::complex<float>> &a, std::int64_t lda, sycl::buffer<std::int64_t> &ipiv,
           sycl::buffer<std::complex<float>> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::hetrf(queue, detail::get_onemkl_uplo(uplo), n, a, lda, ipiv, scratchpad, scratchpad_size));
}
void hetrf(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
           sycl::buffer<std::complex<double>> &a, std::int64_t lda,
           sycl::buffer<std::int64_t> &ipiv, sycl::buffer<std::complex<double>> &scratchpad,
...
void orgbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
           ...
           sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::orgbr(queue, detail::get_onemkl_generate(vec), m, n, k, a, lda, tau, scratchpad, scratchpad_size));
}
void orgbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
...
void orgqr(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
           ...
           sycl::buffer<double> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::orgqr(queue, m, n, k, a, lda, tau, scratchpad, scratchpad_size));
}
void orgqr(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
...
void orgtr(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, sycl::buffer<float> &a,
           std::int64_t lda, sycl::buffer<float> &tau, sycl::buffer<float> &scratchpad,
           std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::orgtr(queue, detail::get_onemkl_uplo(uplo), n, a, lda, tau, scratchpad, scratchpad_size));
}
...
void ormtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
           ...
           sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::ormtr(queue, detail::get_onemkl_side(side), detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), m, n, a, lda, tau, c, ldc, scratchpad,
                                 scratchpad_size));
}
void ormtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
...
void ormrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans, std::int64_t m,
           ...
           sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::ormrq(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc, scratchpad,
                                 scratchpad_size));
}
void ormrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans, std::int64_t m,
...
void ormqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans, std::int64_t m,
           std::int64_t n, std::int64_t k, sycl::buffer<double> &a, std::int64_t lda,
           sycl::buffer<double> &tau, sycl::buffer<double> &c, std::int64_t ldc,
           sycl::buffer<double> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::ormqr(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc, scratchpad,
                                 scratchpad_size));
}
void ormqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans, std::int64_t m,
           std::int64_t n, std::int64_t k, sycl::buffer<float> &a, std::int64_t lda,
...
void potrf(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, sycl::buffer<float> &a,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::potrf(queue, detail::get_onemkl_uplo(uplo), n, a, lda, scratchpad, scratchpad_size));
}
...
void potri(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, sycl::buffer<float> &a,
           std::int64_t lda, sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::potri(queue, detail::get_onemkl_uplo(uplo), n, a, lda, scratchpad, scratchpad_size));
}
...
void potrs(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, std::int64_t nrhs,
           ...
           sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::potrs(queue, detail::get_onemkl_uplo(uplo), n, nrhs, a, lda, b, ldb, scratchpad, scratchpad_size));
}
void potrs(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, std::int64_t nrhs,
...
void syevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
           ...
           sycl::buffer<double> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::syevd(queue, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, a, lda, w, scratchpad, scratchpad_size));
}
void syevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
...
void sygvd(sycl::queue &queue, std::int64_t itype, oneapi::math::job jobz, oneapi::math::uplo uplo,
           ...
           std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::sygvd(queue, itype, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, a, lda, b, ldb, w, scratchpad,
                                 scratchpad_size));
}
void sygvd(sycl::queue &queue, std::int64_t itype, oneapi::math::job jobz, oneapi::math::uplo uplo,
...
void sytrd(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, sycl::buffer<double> &a,
           ...
           std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::sytrd(queue, detail::get_onemkl_uplo(uplo), n, a, lda, d, e, tau, scratchpad, scratchpad_size));
}
...
void sytrf(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, sycl::buffer<float> &a,
           std::int64_t lda, sycl::buffer<std::int64_t> &ipiv, sycl::buffer<float> &scratchpad,
           std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::sytrf(queue, detail::get_onemkl_uplo(uplo), n, a, lda, ipiv, scratchpad, scratchpad_size));
}
...
void trtrs(sycl::queue &queue, oneapi::math::uplo uplo, oneapi::math::transpose trans,
           ...
           sycl::buffer<std::complex<float>> &b, std::int64_t ldb,
           sycl::buffer<std::complex<float>> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::trtrs(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, nrhs, a, lda, b, ldb, scratchpad,
                                 scratchpad_size));
}
void trtrs(sycl::queue &queue, oneapi::math::uplo uplo, oneapi::math::transpose trans,
...
void ungbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
           ...
           std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::ungbr(queue, detail::get_onemkl_generate(vec), m, n, k, a, lda, tau, scratchpad, scratchpad_size));
}
void ungbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
...
void ungqr(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
           ...
           sycl::buffer<std::complex<float>> &tau, sycl::buffer<std::complex<float>> &scratchpad,
           std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::ungqr(queue, m, n, k, a, lda, tau, scratchpad, scratchpad_size));
}
void ungqr(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
           sycl::buffer<std::complex<double>> &a, std::int64_t lda,
           sycl::buffer<std::complex<double>> &tau, sycl::buffer<std::complex<double>> &scratchpad,
...
void ungtr(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
           ...
           sycl::buffer<std::complex<float>> &tau, sycl::buffer<std::complex<float>> &scratchpad,
           std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::ungtr(queue, detail::get_onemkl_uplo(uplo), n, a, lda, tau, scratchpad, scratchpad_size));
}
void ungtr(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
           sycl::buffer<std::complex<double>> &a, std::int64_t lda,
           sycl::buffer<std::complex<double>> &tau, sycl::buffer<std::complex<double>> &scratchpad,
...
void unmrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans, std::int64_t m,
           ...
           std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::unmrq(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc, scratchpad,
                                 scratchpad_size));
}
void unmrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans, std::int64_t m,
...
void unmqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans, std::int64_t m,
           std::int64_t n, std::int64_t k, sycl::buffer<std::complex<float>> &a, std::int64_t lda,
           sycl::buffer<std::complex<float>> &tau, sycl::buffer<std::complex<float>> &c,
           std::int64_t ldc, sycl::buffer<std::complex<float>> &scratchpad,
           std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::unmqr(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc, scratchpad,
                                 scratchpad_size));
}
void unmqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans, std::int64_t m,
           std::int64_t n, std::int64_t k, sycl::buffer<std::complex<double>> &a, std::int64_t lda,
...
void unmtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
           ...
           std::int64_t ldc, sycl::buffer<std::complex<float>> &scratchpad,
           std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::unmtr(queue, detail::get_onemkl_side(side), detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), m, n, a, lda, tau, c, ldc, scratchpad,
                                 scratchpad_size));
}
void unmtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
           oneapi::math::transpose trans, std::int64_t m, std::int64_t n,
...
sycl::event gesvd(sycl::queue &queue, oneapi::math::jobsvd jobu, oneapi::math::jobsvd jobvt,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::gesvd(queue, detail::get_onemkl_jobsvd(jobu), detail::get_onemkl_jobsvd(jobvt), m, n, a, lda, s, u, ldu, vt, ldvt,
...
sycl::event heevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
                  std::complex<float> *a, std::int64_t lda, float *w,
                  std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::heevd(queue, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, a, lda, w, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event heevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
...
sycl::event hegvd(sycl::queue &queue, std::int64_t itype, oneapi::math::job jobz,
                  oneapi::math::uplo uplo, std::int64_t n, std::complex<double> *a, std::int64_t lda,
...
sycl::event hetrd(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::hetrd(queue, detail::get_onemkl_uplo(uplo), n, a, lda, d, e, tau, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event hetrd(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
...
sycl::event orgbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::orgbr(queue, detail::get_onemkl_generate(vec), m, n, k, a, lda, tau, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event orgbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
...
sycl::event ormtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::ormtr(queue, detail::get_onemkl_side(side), detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), m, n, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event ormtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
...
sycl::event ormrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::ormrq(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event ormrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
...
sycl::event ormqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  ...
                  double *tau, double *c, std::int64_t ldc, double *scratchpad,
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::ormqr(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event ormqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  std::int64_t m, std::int64_t n, std::int64_t k, float *a, std::int64_t lda,
...
sycl::event potrs(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, std::int64_t nrhs,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::potrs(queue, detail::get_onemkl_uplo(uplo), n, nrhs, a, lda, b, ldb, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event potrs(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, std::int64_t nrhs,
...
sycl::event syevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
                  double *a, std::int64_t lda, double *w, double *scratchpad,
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::syevd(queue, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, a, lda, w, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event syevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
...
sycl::event sytrd(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, double *a,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::sytrd(queue, detail::get_onemkl_uplo(uplo), n, a, lda, d, e, tau, scratchpad,
                                        scratchpad_size, dependencies));
}
...
sycl::event trtrs(sycl::queue &queue, oneapi::math::uplo uplo, oneapi::math::transpose trans,
                  ...
                  std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::trtrs(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, nrhs, a, lda, b, ldb,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event trtrs(sycl::queue &queue, oneapi::math::uplo uplo, oneapi::math::transpose trans,
...
sycl::event ungbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
                  ...
                  std::complex<float> *tau, std::complex<float> *scratchpad,
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::ungbr(queue, detail::get_onemkl_generate(vec), m, n, k, a, lda, tau, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event ungbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
...
sycl::event unmrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  ...
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::unmrq(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event unmrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
...
sycl::event unmqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  ...
                  std::int64_t ldc, std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::unmqr(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event unmqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  std::int64_t m, std::int64_t n, std::int64_t k, std::complex<double> *a,
...
sycl::event unmtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::unmtr(queue, detail::get_onemkl_side(side), detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), m, n, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event unmtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
                  oneapi::math::transpose trans, std::int64_t m, std::int64_t n,
...
void geqrf_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<float> &a,
                 ...
                 std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::geqrf_batch(queue, m, n, a, lda, stride_a, tau, stride_tau, batch_size,
...
void getri_batch(sycl::queue &queue, std::int64_t n, sycl::buffer<float> &a, std::int64_t lda,
                 ...
                 std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::getri_batch(queue, n, a, lda, stride_a, ipiv, stride_ipiv, batch_size,
                                       scratchpad, scratchpad_size));
}
...
void getrs_batch(sycl::queue &queue, oneapi::math::transpose trans, std::int64_t n,
                 ...
                 sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::getrs_batch(queue, detail::get_onemkl_transpose(trans), n, nrhs, a, lda, stride_a, ipiv, stride_ipiv,
...
void getrf_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<float> &a,
                 ...
                 std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::getrf_batch(queue, m, n, a, lda, stride_a, ipiv, stride_ipiv, batch_size,
                                       scratchpad, scratchpad_size));
}
...
void orgqr_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
                 ...
                 sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::orgqr_batch(queue, m, n, k, a, lda, stride_a, tau, stride_tau,
...
void potrf_batch(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, sycl::buffer<float> &a,
                 std::int64_t lda, std::int64_t stride_a, std::int64_t batch_size,
                 sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::potrf_batch(queue, detail::get_onemkl_uplo(uplo), n, a, lda, stride_a, batch_size, scratchpad,
                                       scratchpad_size));
}
...
void potrs_batch(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, std::int64_t nrhs,
                 ...
                 std::int64_t batch_size, sycl::buffer<float> &scratchpad,
                 std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::potrs_batch(queue, detail::get_onemkl_uplo(uplo), n, nrhs, a, lda, stride_a, b, ldb, stride_b,
                                       batch_size, scratchpad, scratchpad_size));
}
void potrs_batch(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, std::int64_t nrhs,
                 sycl::buffer<double> &a, std::int64_t lda, std::int64_t stride_a,
...
void ungqr_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
                 ...
                 std::int64_t batch_size, sycl::buffer<std::complex<float>> &scratchpad,
                 std::int64_t scratchpad_size) {
    RETHROW_ONEMKL_EXCEPTIONS(::oneapi::mkl::lapack::ungqr_batch(queue, m, n, k, a, lda, stride_a, tau, stride_tau,
                                       batch_size, scratchpad, scratchpad_size));
}
void ungqr_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
                 sycl::buffer<std::complex<double>> &a, std::int64_t lda, std::int64_t stride_a,
...
sycl::event geqrf_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, float *a,
                        ...
                        std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_batch(queue, m, n, a, lda, stride_a, tau, stride_tau,
                                              batch_size, scratchpad, scratchpad_size,
                                              dependencies));
}
...
sycl::event geqrf_batch(sycl::queue &queue, std::int64_t *m, std::int64_t *n, float **a,
                        ...
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_batch(queue, m, n, a, lda, tau, group_count, group_sizes,
                                              scratchpad, scratchpad_size, dependencies));
}
sycl::event geqrf_batch(sycl::queue &queue, std::int64_t *m, std::int64_t *n, double **a,
...
sycl::event getrf_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, float *a,
                        ...
                        std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_batch(queue, m, n, a, lda, stride_a, ipiv, stride_ipiv,
                                              batch_size, scratchpad, scratchpad_size,
                                              dependencies));
}
...
sycl::event getrf_batch(sycl::queue &queue, std::int64_t *m, std::int64_t *n, float **a,
                        ...
                        std::int64_t *group_sizes, float *scratchpad, std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_batch(queue, m, n, a, lda, ipiv, group_count, group_sizes,
                                              scratchpad, scratchpad_size, dependencies));
}
sycl::event getrf_batch(sycl::queue &queue, std::int64_t *m, std::int64_t *n, double **a,
                        std::int64_t *lda, std::int64_t **ipiv, std::int64_t group_count,
...
sycl::event getri_batch(sycl::queue &queue, std::int64_t n, float *a, std::int64_t lda,
                        ...
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_batch(queue, n, a, lda, stride_a, ipiv, stride_ipiv,
                                              batch_size, scratchpad, scratchpad_size,
                                              dependencies));
}
...
sycl::event getri_batch(sycl::queue &queue, std::int64_t *n, float **a, std::int64_t *lda,
                        ...
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_batch(queue, n, a, lda, ipiv, group_count, group_sizes,
                                              scratchpad, scratchpad_size, dependencies));
}
sycl::event getri_batch(sycl::queue &queue, std::int64_t *n, double **a, std::int64_t *lda,
                        std::int64_t **ipiv, std::int64_t group_count, std::int64_t *group_sizes,
...
sycl::event getrs_batch(sycl::queue &queue, oneapi::math::transpose trans, std::int64_t n,
                        ...
                        std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrs_batch(queue, detail::get_onemkl_transpose(trans), n, nrhs, a, lda, stride_a, ipiv,
...
sycl::event getrs_batch(sycl::queue &queue, oneapi::math::transpose *trans, std::int64_t *n,
                        ...
                        std::int64_t *group_sizes, float *scratchpad, std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrs_batch(queue, detail::get_onemkl_transpose(trans), n, nrhs, a, lda, ipiv, b, ldb,
...
sycl::event orgqr_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
                        ...
                        std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgqr_batch(queue, m, n, k, a, lda, stride_a, tau, stride_tau,
                                              batch_size, scratchpad, scratchpad_size,
                                              dependencies));
}
sycl::event orgqr_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
...
sycl::event orgqr_batch(sycl::queue &queue, std::int64_t *m, std::int64_t *n, std::int64_t *k,
                        ...
                        std::int64_t *group_sizes, float *scratchpad, std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgqr_batch(queue, m, n, k, a, lda, tau, group_count, group_sizes,
                                              scratchpad, scratchpad_size, dependencies));
}
sycl::event orgqr_batch(sycl::queue &queue, std::int64_t *m, std::int64_t *n, std::int64_t *k,
...
sycl::event potrf_batch(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, float *a,
                        ...
                        float *scratchpad, std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_batch(queue, detail::get_onemkl_uplo(uplo), n, a, lda, stride_a, batch_size,
                                              scratchpad, scratchpad_size, dependencies));
}
...
sycl::event potrf_batch(sycl::queue &queue, oneapi::math::uplo *uplo, std::int64_t *n, float **a,
                        ...
                        float *scratchpad, std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_batch(queue, detail::get_onemkl_uplo(uplo), n, a, lda, group_count, group_sizes,
                                              scratchpad, scratchpad_size, dependencies));
}
sycl::event potrf_batch(sycl::queue &queue, oneapi::math::uplo *uplo, std::int64_t *n, double **a,
                        std::int64_t *lda, std::int64_t group_count, std::int64_t *group_sizes,
...
sycl::event potrs_batch(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                        ...
                        float *scratchpad, std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrs_batch(queue, detail::get_onemkl_uplo(uplo), n, nrhs, a, lda, stride_a, b, ldb,
...
sycl::event potrs_batch(sycl::queue &queue, oneapi::math::uplo *uplo, std::int64_t *n,
                        ...
                        float *scratchpad, std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrs_batch(queue, detail::get_onemkl_uplo(uplo), n, nrhs, a, lda, b, ldb, group_count,
...
sycl::event ungqr_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
                        ...
                        std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungqr_batch(queue, m, n, k, a, lda, stride_a, tau, stride_tau,
                                              batch_size, scratchpad, scratchpad_size,
                                              dependencies));
}
sycl::event ungqr_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
...
sycl::event ungqr_batch(sycl::queue &queue, std::int64_t *m, std::int64_t *n, std::int64_t *k,
                        ...
                        std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                        const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungqr_batch(queue, m, n, k, a, lda, tau, group_count, group_sizes,
                                              scratchpad, scratchpad_size, dependencies));
}
sycl::event ungqr_batch(sycl::queue &queue, std::int64_t *m, std::int64_t *n, std::int64_t *k,
                        std::complex<double> **a, std::int64_t *lda, std::complex<double> **tau,
...
std::int64_t gebrd_scratchpad_size<float>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                          std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gebrd_scratchpad_size<float>(queue, m, n, lda));
}
template <>
std::int64_t gebrd_scratchpad_size<double>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                           std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gebrd_scratchpad_size<double>(queue, m, n, lda));
}
template <>
std::int64_t gebrd_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t m,
                                                        std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gebrd_scratchpad_size<std::complex<float>>(queue, m, n, lda));
}
template <>
std::int64_t gebrd_scratchpad_size<std::complex<double>>(sycl::queue &queue, std::int64_t m,
                                                         std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gebrd_scratchpad_size<std::complex<double>>(queue, m, n, lda));
}
template <>
std::int64_t gerqf_scratchpad_size<float>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                          std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gerqf_scratchpad_size<float>(queue, m, n, lda));
}
template <>
std::int64_t gerqf_scratchpad_size<double>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                           std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gerqf_scratchpad_size<double>(queue, m, n, lda));
}
template <>
std::int64_t gerqf_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t m,
                                                        std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gerqf_scratchpad_size<std::complex<float>>(queue, m, n, lda));
}
template <>
std::int64_t gerqf_scratchpad_size<std::complex<double>>(sycl::queue &queue, std::int64_t m,
                                                         std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gerqf_scratchpad_size<std::complex<double>>(queue, m, n, lda));
}
template <>
std::int64_t geqrf_scratchpad_size<float>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                          std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_scratchpad_size<float>(queue, m, n, lda));
}
template <>
std::int64_t geqrf_scratchpad_size<double>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                           std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_scratchpad_size<double>(queue, m, n, lda));
}
template <>
std::int64_t geqrf_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t m,
                                                        std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_scratchpad_size<std::complex<float>>(queue, m, n, lda));
}
template <>
std::int64_t geqrf_scratchpad_size<std::complex<double>>(sycl::queue &queue, std::int64_t m,
                                                         std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_scratchpad_size<std::complex<double>>(queue, m, n, lda));
}
template <>
std::int64_t gesvd_scratchpad_size<float>(sycl::queue &queue, oneapi::math::jobsvd jobu,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gesvd_scratchpad_size<float>(queue, detail::get_onemkl_jobsvd(jobu), detail::get_onemkl_jobsvd(jobvt), m, n, lda, ldu,
                                                               ldvt));
}
template <>
std::int64_t gesvd_scratchpad_size<double>(sycl::queue &queue, oneapi::math::jobsvd jobu,
                                           ...
                                           std::int64_t ldvt) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gesvd_scratchpad_size<double>(queue, detail::get_onemkl_jobsvd(jobu), detail::get_onemkl_jobsvd(jobvt), m, n, lda, ldu,
                                                                ldvt));
}
template <>
std::int64_t gesvd_scratchpad_size<std::complex<float>>(sycl::queue &queue,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gesvd_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_jobsvd(jobu), detail::get_onemkl_jobsvd(jobvt), m,
                                                                             n, lda, ldu, ldvt));
}
template <>
std::int64_t gesvd_scratchpad_size<std::complex<double>>(sycl::queue &queue,
                                                         ...
                                                         std::int64_t n, std::int64_t lda,
                                                         std::int64_t ldu, std::int64_t ldvt) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gesvd_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_jobsvd(jobu), detail::get_onemkl_jobsvd(jobvt), m,
                                                                              n, lda, ldu, ldvt));
}
template <>
std::int64_t getrf_scratchpad_size<float>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                          std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_scratchpad_size<float>(queue, m, n, lda));
}
template <>
std::int64_t getrf_scratchpad_size<double>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                           std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_scratchpad_size<double>(queue, m, n, lda));
}
template <>
std::int64_t getrf_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t m,
                                                        std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_scratchpad_size<std::complex<float>>(queue, m, n, lda));
}
template <>
std::int64_t getrf_scratchpad_size<std::complex<double>>(sycl::queue &queue, std::int64_t m,
                                                         std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_scratchpad_size<std::complex<double>>(queue, m, n, lda));
}
template <>
std::int64_t getri_scratchpad_size<float>(sycl::queue &queue, std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_scratchpad_size<float>(queue, n, lda));
}
template <>
std::int64_t getri_scratchpad_size<double>(sycl::queue &queue, std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_scratchpad_size<double>(queue, n, lda));
}
template <>
std::int64_t getri_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t n,
                                                        std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_scratchpad_size<std::complex<float>>(queue, n, lda));
}
template <>
std::int64_t getri_scratchpad_size<std::complex<double>>(sycl::queue &queue, std::int64_t n,
                                                         std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_scratchpad_size<std::complex<double>>(queue, n, lda));
}
template <>
std::int64_t getrs_scratchpad_size<float>(sycl::queue &queue, oneapi::math::transpose trans,
                                          ...
                                          std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrs_scratchpad_size<float>(queue, detail::get_onemkl_transpose(trans), n, nrhs, lda, ldb));
}
template <>
std::int64_t getrs_scratchpad_size<double>(sycl::queue &queue, oneapi::math::transpose trans,
                                           std::int64_t n, std::int64_t nrhs, std::int64_t lda,
                                           std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrs_scratchpad_size<double>(queue, detail::get_onemkl_transpose(trans), n, nrhs, lda, ldb));
}
template <>
std::int64_t getrs_scratchpad_size<std::complex<float>>(sycl::queue &queue,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrs_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_transpose(trans), n, nrhs,
                                                                             lda, ldb));
}
template <>
std::int64_t getrs_scratchpad_size<std::complex<double>>(sycl::queue &queue,
                                                         ...
                                                         std::int64_t n, std::int64_t nrhs,
                                                         std::int64_t lda, std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrs_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_transpose(trans), n, nrhs,
                                                                              lda, ldb));
}
template <>
std::int64_t heevd_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::job jobz,
                                                        ...
                                                        std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::heevd_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n,
                                                                             lda));
}
template <>
std::int64_t heevd_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::job jobz,
                                                         oneapi::math::uplo uplo, std::int64_t n,
                                                         std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::heevd_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n,
                                                                              lda));
}
template <>
std::int64_t hegvd_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t itype,
                                                        ...
                                                        oneapi::math::uplo uplo, std::int64_t n,
                                                        std::int64_t lda, std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::hegvd_scratchpad_size<std::complex<float>>(queue, itype, detail::get_onemkl_job(jobz),
                                                                             detail::get_onemkl_uplo(uplo), n, lda, ldb));
}
template <>
std::int64_t hegvd_scratchpad_size<std::complex<double>>(sycl::queue &queue, std::int64_t itype,
                                                         ...
                                                         oneapi::math::uplo uplo, std::int64_t n,
                                                         std::int64_t lda, std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::hegvd_scratchpad_size<std::complex<double>>(queue, itype, detail::get_onemkl_job(jobz),
                                                                              detail::get_onemkl_uplo(uplo), n, lda, ldb));
}
template <>
std::int64_t hetrd_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::hetrd_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t hetrd_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::hetrd_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t hetrf_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::hetrf_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t hetrf_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::hetrf_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t orgbr_scratchpad_size<float>(sycl::queue &queue, oneapi::math::generate vect,
                                          std::int64_t m, std::int64_t n, std::int64_t k,
                                          std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgbr_scratchpad_size<float>(queue, detail::get_onemkl_generate(vect), m, n, k, lda));
}
template <>
std::int64_t orgbr_scratchpad_size<double>(sycl::queue &queue, oneapi::math::generate vect,
                                           std::int64_t m, std::int64_t n, std::int64_t k,
                                           std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgbr_scratchpad_size<double>(queue, detail::get_onemkl_generate(vect), m, n, k, lda));
}
template <>
std::int64_t orgtr_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                          std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgtr_scratchpad_size<float>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t orgtr_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                           std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgtr_scratchpad_size<double>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t orgqr_scratchpad_size<float>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                          std::int64_t k, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgqr_scratchpad_size<float>(queue, m, n, k, lda));
}
template <>
std::int64_t orgqr_scratchpad_size<double>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                           std::int64_t k, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgqr_scratchpad_size<double>(queue, m, n, k, lda));
}
template <>
std::int64_t ormrq_scratchpad_size<float>(sycl::queue &queue, oneapi::math::side side,
                                          ...
                                          std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ormrq_scratchpad_size<float>(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, lda,
                                                               ldc));
}
template <>
std::int64_t ormrq_scratchpad_size<double>(sycl::queue &queue, oneapi::math::side side,
                                           ...
                                           std::int64_t n, std::int64_t k, std::int64_t lda,
                                           std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ormrq_scratchpad_size<double>(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, lda,
                                                                ldc));
}
template <>
std::int64_t ormqr_scratchpad_size<float>(sycl::queue &queue, oneapi::math::side side,
                                          ...
                                          std::int64_t n, std::int64_t k, std::int64_t lda,
                                          std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ormqr_scratchpad_size<float>(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, lda,
                                                               ldc));
}
template <>
std::int64_t ormqr_scratchpad_size<double>(sycl::queue &queue, oneapi::math::side side,
                                           ...
                                           std::int64_t n, std::int64_t k, std::int64_t lda,
                                           std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ormqr_scratchpad_size<double>(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, lda,
                                                                ldc));
}
template <>
std::int64_t ormtr_scratchpad_size<float>(sycl::queue &queue, oneapi::math::side side,
                                          ...
                                          std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ormtr_scratchpad_size<float>(queue, detail::get_onemkl_side(side), detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), m, n, lda,
                                                               ldc));
}
template <>
std::int64_t ormtr_scratchpad_size<double>(sycl::queue &queue, oneapi::math::side side,
                                           ...
                                           std::int64_t m, std::int64_t n, std::int64_t lda,
                                           std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ormtr_scratchpad_size<double>(queue, detail::get_onemkl_side(side), detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), m, n, lda,
                                                                ldc));
}
template <>
std::int64_t potrf_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                          std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_scratchpad_size<float>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t potrf_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                           std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_scratchpad_size<double>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t potrf_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t potrf_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t potrs_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                          std::int64_t n, std::int64_t nrhs, std::int64_t lda,
                                          std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrs_scratchpad_size<float>(queue, detail::get_onemkl_uplo(uplo), n, nrhs, lda, ldb));
}
template <>
std::int64_t potrs_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                           std::int64_t n, std::int64_t nrhs, std::int64_t lda,
                                           std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrs_scratchpad_size<double>(queue, detail::get_onemkl_uplo(uplo), n, nrhs, lda, ldb));
}
template <>
std::int64_t potrs_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t nrhs,
                                                        std::int64_t lda, std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrs_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_uplo(uplo), n, nrhs,
                                                                             lda, ldb));
}
template <>
std::int64_t potrs_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t nrhs,
                                                         std::int64_t lda, std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrs_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_uplo(uplo), n, nrhs,
                                                                              lda, ldb));
}
template <>
std::int64_t potri_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                          std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potri_scratchpad_size<float>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t potri_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                           std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potri_scratchpad_size<double>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t potri_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potri_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t potri_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potri_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t sytrf_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                          std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::sytrf_scratchpad_size<float>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t sytrf_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                           std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::sytrf_scratchpad_size<double>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t sytrf_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::sytrf_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t sytrf_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::sytrf_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t syevd_scratchpad_size<float>(sycl::queue &queue, oneapi::math::job jobz,
                                          oneapi::math::uplo uplo, std::int64_t n,
                                          std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::syevd_scratchpad_size<float>(queue, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t syevd_scratchpad_size<double>(sycl::queue &queue, oneapi::math::job jobz,
                                           oneapi::math::uplo uplo, std::int64_t n,
                                           std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::syevd_scratchpad_size<double>(queue, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t sygvd_scratchpad_size<float>(sycl::queue &queue, std::int64_t itype,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::sygvd_scratchpad_size<float>(queue, itype, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, lda,
                                                               ldb));
}
template <>
std::int64_t sygvd_scratchpad_size<double>(sycl::queue &queue, std::int64_t itype,
                                           oneapi::math::job jobz, oneapi::math::uplo uplo,
                                           std::int64_t n, std::int64_t lda, std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::sygvd_scratchpad_size<double>(queue, itype, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, lda,
                                                                ldb));
}
template <>
std::int64_t sytrd_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                          std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::sytrd_scratchpad_size<float>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t sytrd_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                           std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::sytrd_scratchpad_size<double>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t trtrs_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                          ...
                                          std::int64_t n, std::int64_t nrhs, std::int64_t lda,
                                          std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::trtrs_scratchpad_size<float>(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, nrhs,
                                                               lda, ldb));
}
template <>
std::int64_t trtrs_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                           ...
                                           std::int64_t n, std::int64_t nrhs, std::int64_t lda,
                                           std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::trtrs_scratchpad_size<double>(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, nrhs,
                                                                lda, ldb));
}
template <>
std::int64_t trtrs_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::uplo uplo,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::trtrs_scratchpad_size<std::complex<float>>(
        queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, nrhs, lda, ldb));
}
template <>
std::int64_t trtrs_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         oneapi::math::transpose trans,
                                                         oneapi::math::diag diag, std::int64_t n,
                                                         std::int64_t nrhs, std::int64_t lda,
                                                         std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::trtrs_scratchpad_size<std::complex<double>>(
        queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, nrhs, lda, ldb));
}
template <>
std::int64_t ungbr_scratchpad_size<std::complex<float>>(sycl::queue &queue,
                                                        ...
                                                        std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungbr_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_generate(vect), m, n, k,
                                                                             lda));
}
template <>
std::int64_t ungbr_scratchpad_size<std::complex<double>>(sycl::queue &queue,
                                                         ...
                                                         std::int64_t n, std::int64_t k,
                                                         std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungbr_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_generate(vect), m, n, k,
                                                                              lda));
}
template <>
std::int64_t ungqr_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t m,
                                                        std::int64_t n, std::int64_t k,
                                                        std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungqr_scratchpad_size<std::complex<float>>(queue, m, n, k, lda));
}
template <>
std::int64_t ungqr_scratchpad_size<std::complex<double>>(sycl::queue &queue, std::int64_t m,
                                                         std::int64_t n, std::int64_t k,
                                                         std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungqr_scratchpad_size<std::complex<double>>(queue, m, n, k, lda));
}
template <>
std::int64_t ungtr_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungtr_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t ungtr_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungtr_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_uplo(uplo), n, lda));
}
template <>
std::int64_t unmrq_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::side side,
                                                        ...
                                                        std::int64_t k, std::int64_t lda,
                                                        std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::unmrq_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m,
                                                                             n, k, lda, ldc));
}
template <>
std::int64_t unmrq_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::side side,
                                                         ...
                                                         std::int64_t k, std::int64_t lda,
                                                         std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::unmrq_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m,
                                                                              n, k, lda, ldc));
}
template <>
std::int64_t unmqr_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::side side,
                                                        ...
                                                        std::int64_t k, std::int64_t lda,
                                                        std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::unmqr_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m,
                                                                             n, k, lda, ldc));
}
template <>
std::int64_t unmqr_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::side side,
                                                         oneapi::math::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t k, std::int64_t lda,
                                                         std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::unmqr_scratchpad_size<std::complex<double>>(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m,
                                                                              n, k, lda, ldc));
}
template <>
std::int64_t unmtr_scratchpad_size<std::complex<float>>(sycl::queue &queue, oneapi::math::side side,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::unmtr_scratchpad_size<std::complex<float>>(queue, detail::get_onemkl_side(side), detail::get_onemkl_uplo(uplo),
                                                                             detail::get_onemkl_transpose(trans), m, n, lda, ldc));
}
template <>
std::int64_t unmtr_scratchpad_size<std::complex<double>>(sycl::queue &queue, oneapi::math::side side,
                                                         oneapi::math::uplo uplo,
                                                         oneapi::math::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t lda, std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::unmtr_scratchpad_size<std::complex<double>>(
        queue, detail::get_onemkl_side(side), detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), m, n, lda, ldc));
}
template <>
std::int64_t getrf_batch_scratchpad_size<float>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                                std::int64_t lda, std::int64_t stride_a,
                                                std::int64_t stride_ipiv, std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_batch_scratchpad_size<float>(queue, m, n, lda, stride_a,
...
std::int64_t getrf_batch_scratchpad_size<double>(sycl::queue &queue, std::int64_t m, std::int64_t n,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_batch_scratchpad_size<double>(queue, m, n, lda, stride_a,
                                                                      stride_ipiv, batch_size));
}
template <>
std::int64_t getrf_batch_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t m,
                                                              ...
                                                              std::int64_t stride_ipiv,
                                                              std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_batch_scratchpad_size<std::complex<float>>(
...
std::int64_t getrf_batch_scratchpad_size<std::complex<double>>(sycl::queue &queue, std::int64_t m,
                                                               ...
                                                               std::int64_t stride_ipiv,
                                                               std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_batch_scratchpad_size<std::complex<double>>(
        queue, m, n, lda, stride_a, stride_ipiv, batch_size));
}
template <>
std::int64_t getri_batch_scratchpad_size<float>(sycl::queue &queue, std::int64_t n,
                                                std::int64_t lda, std::int64_t stride_a,
                                                std::int64_t stride_ipiv, std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_batch_scratchpad_size<float>(queue, n, lda, stride_a,
                                                                     stride_ipiv, batch_size));
}
template <>
std::int64_t getri_batch_scratchpad_size<double>(sycl::queue &queue, std::int64_t n,
                                                 ...
                                                 std::int64_t stride_ipiv,
                                                 std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_batch_scratchpad_size<double>(queue, n, lda, stride_a,
                                                                      stride_ipiv, batch_size));
}
template <>
std::int64_t getri_batch_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t n,
                                                              ...
                                                              std::int64_t stride_ipiv,
                                                              std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_batch_scratchpad_size<std::complex<float>>(
...
std::int64_t getri_batch_scratchpad_size<std::complex<double>>(sycl::queue &queue, std::int64_t n,
                                                               ...
                                                               std::int64_t stride_ipiv,
                                                               std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_batch_scratchpad_size<std::complex<double>>(
        queue, n, lda, stride_a, stride_ipiv, batch_size));
}
template <>
std::int64_t getrs_batch_scratchpad_size<float>(sycl::queue &queue, oneapi::math::transpose trans,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrs_batch_scratchpad_size<float>(
        queue, detail::get_onemkl_transpose(trans), n, nrhs, lda, stride_a, stride_ipiv, ldb, stride_b, batch_size));
}
template <>
...
std::int64_t getrs_batch_scratchpad_size<std::complex<float>>(
    ...
    std::int64_t stride_b, std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrs_batch_scratchpad_size<std::complex<float>>(
        queue, detail::get_onemkl_transpose(trans), n, nrhs, lda, stride_a, stride_ipiv, ldb, stride_b, batch_size));
}
template <>
std::int64_t getrs_batch_scratchpad_size<std::complex<double>>(
    ...
    std::int64_t lda, std::int64_t stride_a, std::int64_t stride_ipiv, std::int64_t ldb,
    std::int64_t stride_b, std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrs_batch_scratchpad_size<std::complex<double>>(
        queue, detail::get_onemkl_transpose(trans), n, nrhs, lda, stride_a, stride_ipiv, ldb, stride_b, batch_size));
}
template <>
std::int64_t geqrf_batch_scratchpad_size<float>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                                std::int64_t lda, std::int64_t stride_a,
                                                std::int64_t stride_tau, std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_batch_scratchpad_size<float>(queue, m, n, lda, stride_a,
...
std::int64_t geqrf_batch_scratchpad_size<double>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                                 std::int64_t lda, std::int64_t stride_a,
                                                 std::int64_t stride_tau, std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_batch_scratchpad_size<double>(queue, m, n, lda, stride_a,
                                                                      stride_tau, batch_size));
}
template <>
std::int64_t geqrf_batch_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t m,
                                                              ...
                                                              std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_batch_scratchpad_size<std::complex<float>>(
...
std::int64_t geqrf_batch_scratchpad_size<std::complex<double>>(sycl::queue &queue, std::int64_t m,
                                                               ...
                                                               std::int64_t stride_tau,
                                                               std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_batch_scratchpad_size<std::complex<double>>(
        queue, m, n, lda, stride_a, stride_tau, batch_size));
}
template <>
std::int64_t potrf_batch_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_batch_scratchpad_size<float>(queue, detail::get_onemkl_uplo(uplo), n, lda, stride_a,
                                                                     batch_size));
}
template <>
std::int64_t potrf_batch_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                 std::int64_t n, std::int64_t lda,
                                                 std::int64_t stride_a, std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_batch_scratchpad_size<double>(queue, detail::get_onemkl_uplo(uplo), n, lda, stride_a,
                                                                      batch_size));
}
template <>
std::int64_t potrf_batch_scratchpad_size<std::complex<float>>(sycl::queue &queue,
                                                              ...
                                                              std::int64_t stride_a,
                                                              std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_batch_scratchpad_size<std::complex<float>>(
...
std::int64_t potrf_batch_scratchpad_size<std::complex<double>>(sycl::queue &queue,
                                                               ...
                                                               std::int64_t stride_a,
                                                               std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_batch_scratchpad_size<std::complex<double>>(
        queue, detail::get_onemkl_uplo(uplo), n, lda, stride_a, batch_size));
}
template <>
...
std::int64_t potrs_batch_scratchpad_size<std::complex<float>>(
    sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, std::int64_t nrhs, std::int64_t lda,
    std::int64_t stride_a, std::int64_t ldb, std::int64_t stride_b, std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrs_batch_scratchpad_size<std::complex<float>>(
        queue, detail::get_onemkl_uplo(uplo), n, nrhs, lda, stride_a, ldb, stride_b, batch_size));
}
template <>
std::int64_t potrs_batch_scratchpad_size<std::complex<double>>(
    sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, std::int64_t nrhs, std::int64_t lda,
    std::int64_t stride_a, std::int64_t ldb, std::int64_t stride_b, std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrs_batch_scratchpad_size<std::complex<double>>(
        queue, detail::get_onemkl_uplo(uplo), n, nrhs, lda, stride_a, ldb, stride_b, batch_size));
}
template <>
std::int64_t orgqr_batch_scratchpad_size<float>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                                ...
                                                std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgqr_batch_scratchpad_size<float>(queue, m, n, k, lda, stride_a,
                                                                     stride_tau, batch_size));
}
template <>
std::int64_t orgqr_batch_scratchpad_size<double>(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                                 ...
                                                 std::int64_t stride_a, std::int64_t stride_tau,
                                                 std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgqr_batch_scratchpad_size<double>(queue, m, n, k, lda, stride_a,
                                                                      stride_tau, batch_size));
}
template <>
std::int64_t ungqr_batch_scratchpad_size<std::complex<float>>(
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungqr_batch_scratchpad_size<std::complex<float>>(
...
std::int64_t ungqr_batch_scratchpad_size<std::complex<double>>(
    sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k, std::int64_t lda,
    std::int64_t stride_a, std::int64_t stride_tau, std::int64_t batch_size) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungqr_batch_scratchpad_size<std::complex<double>>(
        queue, m, n, k, lda, stride_a, stride_tau, batch_size));
}
template <>
std::int64_t getrf_batch_scratchpad_size<float>(sycl::queue &queue, std::int64_t *m,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_batch_scratchpad_size<float>(queue, m, n, lda, group_count,
                                                                     group_sizes));
}
template <>
std::int64_t getrf_batch_scratchpad_size<double>(sycl::queue &queue, std::int64_t *m,
                                                 ...
                                                 std::int64_t group_count,
                                                 std::int64_t *group_sizes) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf_batch_scratchpad_size<double>(queue, m, n, lda, group_count,
                                                                      group_sizes));
}
template <>
std::int64_t getrf_batch_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t *m,
...
std::int64_t getri_batch_scratchpad_size<float>(sycl::queue &queue, std::int64_t *n,
                                                ...
                                                std::int64_t *group_sizes) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_batch_scratchpad_size<float>(queue, n, lda, group_count,
                                                                     group_sizes));
}
template <>
std::int64_t getri_batch_scratchpad_size<double>(sycl::queue &queue, std::int64_t *n,
                                                 std::int64_t *lda, std::int64_t group_count,
                                                 std::int64_t *group_sizes) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri_batch_scratchpad_size<double>(queue, n, lda, group_count,
                                                                      group_sizes));
}
template <>
std::int64_t getri_batch_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t *n,
...
std::int64_t getrs_batch_scratchpad_size<float>(sycl::queue &queue, oneapi::math::transpose *trans,
                                                ...
                                                std::int64_t group_count,
                                                std::int64_t *group_sizes) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrs_batch_scratchpad_size<float>(queue, detail::get_onemkl_transpose(trans), n, nrhs, lda,
...
std::int64_t geqrf_batch_scratchpad_size<float>(sycl::queue &queue, std::int64_t *m,
                                                ...
                                                std::int64_t group_count,
                                                std::int64_t *group_sizes) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_batch_scratchpad_size<float>(queue, m, n, lda, group_count,
                                                                     group_sizes));
}
template <>
std::int64_t geqrf_batch_scratchpad_size<double>(sycl::queue &queue, std::int64_t *m,
                                                 ...
                                                 std::int64_t group_count,
                                                 std::int64_t *group_sizes) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf_batch_scratchpad_size<double>(queue, m, n, lda, group_count,
                                                                      group_sizes));
}
template <>
std::int64_t geqrf_batch_scratchpad_size<std::complex<float>>(sycl::queue &queue, std::int64_t *m,
...
std::int64_t orgqr_batch_scratchpad_size<float>(sycl::queue &queue, std::int64_t *m,
                                                ...
                                                std::int64_t group_count,
                                                std::int64_t *group_sizes) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgqr_batch_scratchpad_size<float>(queue, m, n, k, lda,
...
std::int64_t orgqr_batch_scratchpad_size<double>(sycl::queue &queue, std::int64_t *m,
                                                 ...
                                                 std::int64_t *lda, std::int64_t group_count,
                                                 std::int64_t *group_sizes) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgqr_batch_scratchpad_size<double>(queue, m, n, k, lda,
                                                                      group_count, group_sizes));
}
template <>
std::int64_t potrf_batch_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo *uplo,
                                                ...
                                                std::int64_t group_count,
                                                std::int64_t *group_sizes) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_batch_scratchpad_size<float>(queue, detail::get_onemkl_uplo(uplo), n, lda,
                                                                     group_count, group_sizes));
}
template <>
std::int64_t potrf_batch_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo *uplo,
                                                 ...
                                                 std::int64_t group_count,
                                                 std::int64_t *group_sizes) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf_batch_scratchpad_size<double>(queue, detail::get_onemkl_uplo(uplo), n, lda,
                                                                      group_count, group_sizes));
}
template <>
std::int64_t potrf_batch_scratchpad_size<std::complex<float>>(sycl::queue &queue,
...
std::int64_t potrs_batch_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo *uplo,
                                                ...
                                                std::int64_t group_count,
                                                std::int64_t *group_sizes) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrs_batch_scratchpad_size<float>(queue, detail::get_onemkl_uplo(uplo), n, nrhs, lda, ldb,
                                                                     group_count, group_sizes));
}
template <>
std::int64_t potrs_batch_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo *uplo,
