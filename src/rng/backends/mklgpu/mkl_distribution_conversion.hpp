...
#ifndef _ONEMATH_SRC_RNG_MKL_DISTRIBUTION_CONVERSION_HPP_
#define _ONEMATH_SRC_RNG_MKL_DISTRIBUTION_CONVERSION_HPP_
...
#endif // _ONEMATH_SRC_RNG_MKL_DISTRIBUTION_CONVERSION_HPP_
